 ...
 * Imported from https://github.com/petrnohejl/Android-Templates-And-Utilities
 * TODO: We should give credit due to Apache 2.0 License
 */
...
//		canvas.rotate(mAngle % 360, canvas.getWidth() / 2, canvas.getHeight() / 2);
		canvas.rotate(mAngle % 360, canvas.getWidth() / 2, canvas.getHeight()); //rotate from the bottom instead of the center
		super.onDraw(canvas);
		canvas.restore();
